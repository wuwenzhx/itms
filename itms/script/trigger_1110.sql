...
CREATE DATABASE IF NOT EXISTS `itms_new` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `itms_new`;


-- Dumping structure for trigger itms_new.itms_perf_testsuite_result_after_insert
...
-- Dumping structure for trigger itms_new.itms_testsuite_result_after_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='';
DELIMITER //
