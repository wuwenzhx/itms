...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerfDPDKReportInfo'
        db.create_table(u'cmsplugin_perfdpdkreportinfo', (
        ...
        db.send_create_signal(u'report', ['PerfDPDKReportInfo'])


    def backwards(self, orm):
        # Deleting model 'PerfDPDKReportInfo'
        db.delete_table(u'cmsplugin_perfdpdkreportinfo')
    ...
    models = {
        ...
        u'report.perfdpdkreportinfo': {
            'Meta': {'object_name': 'PerfDPDKReportInfo', 'db_table': "u'cmsplugin_perfdpdkreportinfo'", '_ormbases': ['cms.CMSPlugin']},
