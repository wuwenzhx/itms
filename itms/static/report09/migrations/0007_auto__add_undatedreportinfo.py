...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UndatedReportInfo'
        db.create_table(u'cmsplugin_undatedreportinfo', (
        ...
        db.send_create_signal(u'report', ['UndatedReportInfo'])


    def backwards(self, orm):
        # Deleting model 'UndatedReportInfo'
        db.delete_table(u'cmsplugin_undatedreportinfo')
