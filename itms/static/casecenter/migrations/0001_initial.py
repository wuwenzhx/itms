...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RequirementInfo'
        db.create_table(u'cmsplugin_requirementinfo', (
        ...
        db.send_create_signal(u'casecenter', ['RequirementInfo'])

        # Adding model 'FeatureInfo'
        db.create_table(u'cmsplugin_featureinfo', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=50)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'casecenter', ['FeatureInfo'])

        # Adding model 'TestCaseInfo'
        db.create_table(u'cmsplugin_testcaseinfo', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=50)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'casecenter', ['TestCaseInfo'])


    def backwards(self, orm):
        # Deleting model 'RequirementInfo'
        db.delete_table(u'cmsplugin_requirementinfo')

        # Deleting model 'FeatureInfo'
        db.delete_table(u'cmsplugin_featureinfo')

        # Deleting model 'TestCaseInfo'
        db.delete_table(u'cmsplugin_testcaseinfo')
