...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegularReportChart'
        db.create_table(u'cmsplugin_regularreportchart', (
        ...
        db.send_create_signal(u'report', ['RegularReportChart'])


    def backwards(self, orm):
        # Deleting model 'RegularReportChart'
        db.delete_table(u'cmsplugin_regularreportchart')
