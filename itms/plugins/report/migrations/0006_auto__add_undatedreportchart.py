...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UndatedReportChart'
        db.create_table(u'cmsplugin_undatedreportchart', (
        ...
        db.send_create_signal(u'report', ['UndatedReportChart'])


    def backwards(self, orm):
        # Deleting model 'UndatedReportChart'
        db.delete_table(u'cmsplugin_undatedreportchart')
