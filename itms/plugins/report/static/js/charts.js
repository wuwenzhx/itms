...
function show_spdk_report_chart(chart_data, div, rw_type, case_type) {
    var myChart_regular = echarts.init(document.getElementById(div), normal),
        ...
        option = {
    title : {
        text: 'Spdk_'+case_type+'_4K_'+rw_type+'_Report',
        subtext: 'MAX Total Bandwidth'
    },
    tooltip : {
        trigger: 'axis'
    },
    ...
    series : [
        {
            ...
            markPoint : {
                data : [
                    {type : 'max', name: 'Max_Total_Iops'},
                    {type : 'min', name: 'Min_Total_Iops'}
                ]
            },
            markLine : {
                data : [
			//[{name:'Expect_value',value:800000,xAxis:-1,yAxis:800000},{xAxis:100,yAxis:800000},lineStyle:{color:'read'}],
			[{name:'Expect_value',value:760000,xAxis:-1,yAxis:760000},{xAxis:100,yAxis:760000,itemStyle:{normal:{width:3.0,color:'red'}}}],
       ...
       /* {
		...
		
		{
            ...
            markPoint : {
                data : [
                    {type : 'max', name: 'Max_Averange_latency'},
                    {type : 'min', name: 'Min_Average_latency'}
                ]
            },
            markLine : {
                data : [
...
option = {
	title:{
		text: '4K_'+os+'-'+platform+'QueueDepth: ',
        subtext: 'Total Bandwidth'
	},
    tooltip : {
        trigger: 'axis'
    },
    ...
    series : [
 	...
 	markLine:{
		data:[
			[{name:'Expect_value',value:760000,xAxis:-1,yAxis:760000},{xAxis:100,yAxis:760000,itemStyle:{normal:{width:3.0,color:'red'}}}],
			//[{name:'Expect_value',value:800000,xAxis:-1,yAxis:800000},{xAxis:100,yAxis:800000}],
                    {type : 'average', name: 'Average'}
			]
        ...
        },
        {
            ...
            markPoint : {
                data : [
                    {type : 'max', name: 'Max_Average_latency'},
                    {type : 'min', name: 'Min_Average_latency'}
                ]
            },
 	markLine:{
		data:[
			[{name:'Expect_value',value:760000,xAxis:-1,yAxis:222},{xAxis:100,yAxis:222}],
                    {type : 'average', name: 'Average'}
			]
