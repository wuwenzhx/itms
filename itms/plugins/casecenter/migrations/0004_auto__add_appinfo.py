...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_appinfo', (
        ...
        db.send_create_signal(u'casecenter', ['AppInfo'])


    def backwards(self, orm):
        # Deleting model 'AppInfo'
        db.delete_table(u'cmsplugin_appinfo')


    models = {
        u'casecenter.appinfo': {
            'Meta': {'object_name': 'AppInfo', 'db_table': "u'cmsplugin_appinfo'", '_ormbases': ['cms.CMSPlugin']},
