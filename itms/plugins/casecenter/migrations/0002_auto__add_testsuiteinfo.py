...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestSuiteInfo'
        db.create_table(u'cmsplugin_testsuiteinfo', (
        ...
        db.send_create_signal(u'casecenter', ['TestSuiteInfo'])


    def backwards(self, orm):
        # Deleting model 'TestSuiteInfo'
        db.delete_table(u'cmsplugin_testsuiteinfo')
